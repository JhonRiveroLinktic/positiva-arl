...
import { CambioOcupacionIndependienteVoluntarioForm } from "@/lib/components/cambio-ocupacion-independiente-voluntario";
import { Suspense } from "react";

function FormularioCambioOcupacionIndependienteVoluntarioFormFallback() {
  return (
...
export default function CambioOcupacionIndependienteVoluntario() {
  return (
    <main>
      <Header />
      <div className="w-full flex flex-col items-center justify-items-center gap-6 px-4 py-8 bg-gray-50 min-h-screen">
        <Banner 
          title="Cambio Ocupación - Independiente Voluntario" 
          description="Complete todos los campos requeridos para procesar el cambio de de ocupación del trabajador independiente voluntario." 
        /> 
        <CardDownloadExcel
