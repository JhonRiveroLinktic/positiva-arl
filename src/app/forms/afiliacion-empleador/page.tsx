...
export default function AfiliacionEmpleadorPage() {
  return (
    <main>
      <Header />
      <div className="w-full flex flex-col items-center justify-items-center gap-6 px-4 py-8 bg-gray-50 min-h-screen">
        <Banner 
          title="Formulario de Afiliación Empleador (Empresas, Sedes - Sucursales - Centro de trabajo Y RL)" 
        ...
        {/* <CardDownloadExcel
          ...
          description="Descarga nuestra plantilla base en Excel, diligénciala con la información de cada empleador y representante legal y súbela fácilmente mediante la opción de carga masiva."
