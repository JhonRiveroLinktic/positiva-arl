...
const EXCEL_COLUMN_MAPPING = {
  ...
  'FECHA_DE_NACIMIENTO_DEL_TRABAJADOR (DD/MM/AAAA)': 'fechaNacimientoTrabajador',
  ...
  'CODIGO_DANE_DEPARTAMENTO_SITIO_TRABAJO_INDEPENDIENTE': 'codigoDaneDptoSitioTrabajo',
  'CODIGO_DANE_MUNICIPIO_SITIO_TRABAJO_INDEPENDIENTE': 'codigoDaneMuniSitioTrabajo',
  'FECHA_DE_COBERTURA_(DD/MM/AAAA)': 'fechaCobertura',
  'TIPO_DE_DOCUMENTO_CONYUGE O_RESPONSABLE_DE_LA_FILIACION': 'tipoDocConyugeResponsable',
  'NUMERO_DE_DOCUMENTO_CONYUGE_O_RESPONSABLE_DE_LA_FILIACION': 'numeDocConyugeResponsable',
  'PRIMER_NOMBRE_CONYUGE_O_RESPONSABLE_DE_LA_AFILIACION': 'nombre1ConyugeResponsable',
  'SEGUNDO_NOMBRE_CONYUGE_O_RESPONSABLE_DE_LA_AFILIACION': 'nombre2ConyugeResponsable',
  'PRIMER_APELLIDO_CONYUGE_O_RESPONSABLE_DE_LA_AFILIACION': 'apellido1ConyugeResponsable',
  'SEGUNDO_APELLIDO_CONYUGE_O_RESPONSABLE_DE_LA_AFILIACION': 'apellido2ConyugeResponsable',
  'DEPARTAMENTO_DE_RESIDENCIA_CONYUGE_O_RESPONSABLE_DE_LA_AFILIACION': 'dptoResidenciaConyugeResponsable',
  'MUNICIPIO_DE_RESIDENCIA_CONYUGE_O_RESPONSABLE_DE_LA_AFILIACION': 'muniResidenciaConyugeResponsable',
  'DIRECCIÓN_DE_RESIDENCIA_CONYUGE_O_RESPONSABLE_DE_LA_AFILIACION': 'direccionResidenciaConyugeResponsable',
  'NUMERO_TELEFONICO_CONYUGE_O_RESPONSABLE_DE_LA_AFILIACION': 'telefonoConyugeResponsable',
} as const;
...
export function IndependienteVoluntarioMassiveUpload({ trigger, onSuccess, onError }: IndependienteVoluntarioMassiveUploadProps) {
  ...
  const validateFileStructure = useCallback((headers: string[]) => {
    ...
    const requiredColumnsNormalized = [
      ...
      normalizeHeader('FECHA_DE_NACIMIENTO_DEL_TRABAJADOR (DD/MM/AAAA)'),
      ...
      normalizeHeader('CODIGO_DANE_DEPARTAMENTO_SITIO_TRABAJO_INDEPENDIENTE'),
      normalizeHeader('CODIGO_DANE_MUNICIPIO_SITIO_TRABAJO_INDEPENDIENTE'),
